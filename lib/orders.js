...
module.exports = class Orders {
    constructor(state){
        ...
        this.columns = [
            ...
            {name: 'filled', title: 'Filled', default: true, accessor: o => o.filled},
            {name: 'price', title: 'Price', default: true, accessor: o => o.limit ? o.limit.toFixed(o.market.precision.price) : '-'},
            {name: 'stop', title: 'Stop', default: true, accessor: o => (o.type === 'stop' && o.stop) ? o.stop.toFixed(o.market.precision.price) : '-'},
            ...
            {name: 'status', title: 'Order Status', default: true, accessor: o => o.status},
            {
                name: 'options',
                title: 'Options',
                default: true,
