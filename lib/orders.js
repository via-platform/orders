...
module.exports = class Orders {
    ...
    constructor(state){
        ...
        this.columns = [
            {name: 'exchange', title: 'Exchange', default: true, accessor: o => o.market.exchange.name},
            {name: 'market', title: 'Market', default: true, accessor: o => o.market.name},
            ...
            {name: 'filled', title: 'Filled', default: true, accessor: o => o.isPending() ? '-' : o.filled.toFixed(o.market.precision.amount)},
            {name: 'remaining', title: 'Remaining', default: false, accessor: o => o.isPending() ? '-' : o.remaining.toFixed(o.market.precision.amount)},
            ...
            {name: 'fees', title: 'Fees', default: true, accessor: o => o.fee ? o.fee : '-'},
